...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST["snoEdit"])) {
        ...
        $sql = "UPDATE `login_user1` SET `Email_Phone_no` = ?, `Password` = ? WHERE `id` = ?";
        ...
        $sql = "DELETE FROM `login_user1` WHERE `id` = ?";
        $stmt = mysqli_prepare($conn, $sql);
        ...
        $sql = "INSERT INTO `login_user1` (`uname`, `email`, `pass`) VALUES (?, ?, ?)";
        $stmt = mysqli_prepare($conn, $sql);
...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/Myntra/userm.php" method="post">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" tabindex="-1">Order Management</a>
          </li>
          <li class="nav-item">
  ...
  <!-- <table class="table" id="myTable">
    ...
    <tbody>
      ...
      //             <a href='/php/del?id=" . $row['id'] . "'>Delete</a>
      //           </td>
      //         </tr>";
      // }
      // ?> -->
    ...
    <tbody>
        ...
        $result = mysqli_query($conn, $sql);
          ...
          if (mysqli_num_rows($result) > 0)
          {
            ...
            while($row = mysqli_fetch_assoc($result)) {
              echo "id: " . $row["Sr No."]. " - Email_Phone: " . $row["Email_Phone_no"]. " " . $row["Password"]. "<br>";
            }
          } 
          else 
          {
